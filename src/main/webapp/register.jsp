...
<body>
<nav>
    <img src="images/logo.png" height="60" width="170" alt="">
    <div>欢迎注册</div>
...
<div id="web">  
    <form  method="post">
        ...
        <div class="form_item">  
            <label>设 置 密 码</label>  
            <input type="password" value="" placeholder="建议至少使用两种字符组合" id="pwd" name="pwd" />  
        </div>  
        <div class="input-tip">  
        ...
        <div class="form_item">
            <label>确 认 密 码</label>
            <input type="password" value="" placeholder="请再次输入密码" id="confirm_pwd" name="confirm_pwd" />  
        </div>  
        <div class="input-tip">
